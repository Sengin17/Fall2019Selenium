...
public class OfficeHour_03_17_2020_HCode {
...
//        state.sendKeys(contact1.get("State"));
        ...
        String uiPhone = driver.findElement(By.className("")).getText();
        Assert.assertEquals(uiPhone, contact1.get("Phone"));

        String uiStreet = driver.findElement(By.tagName("address")).getText();
