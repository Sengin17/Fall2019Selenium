...
public class SeleniumOH2 {
    public static void main(String[] args) {
        ...
        2. Search for "Tshirt" in a searchbox + click enter OR click button
        ...
        // arayacagin nesneyi girersin arama alaninda sag tiklayip inspet yaparsin ve aramaya ait html in id sini alirsin
         ...
         */
        // aranacak kelimeyi yazarsin ve Keys.Enter kullanarak tiklama olayini gerceklestiirisin
        ...
        // //p[@class=‘alert alert-warning’] --> html den gelen path
