...
//        link.click();
        ...
        //from left - to right
        js.executeScript("arguments[0].click()", link); //class name... args ==>  like array
                                                             //lets us specify 0 or more webElements there is no limit

        WebElement button6 = driver.findElement(By.id("disappearing_button")); // find button number 6
    ...
    public void scrollToElement(){
        ...
        // Scrool is like confirm that is visible
        //scroll untill it’s true, become visible
